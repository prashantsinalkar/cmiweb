...
function cmi_form_system_theme_settings_alter(&$form, Drupal\Core\Form\FormStateInterface $form_state) {
...
// Page Header
  ...
  $form['options']['design']['site_name_visibility'] = array(
      '#type' => 'fieldset',
      '#title' => '<div class="plus"></div><h3 class="options_heading">Site Name Visibility</h3>',
  );
  $form['options']['design']['site_name_visibility']['site_name_visibility_options'] = array(
    '#type' => 'select',
    '#title' => 'Select a site name visibility',
    '#default_value' => theme_get_setting('site_name_visibility'),
    '#options' => array(
        'none' => 'None',
        'Visible' => 'Visible',
        'Hidden' => 'Hidden'
